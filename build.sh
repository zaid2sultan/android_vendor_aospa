#!/usr/bin/env bash
# The AtomX Project build helper script
...
echo -e "${CLR_BLD_GRN}Building AtomX $ATOMX_DISPLAY_VERSION for $DEVICE${CLR_RST}"
...
echo -e ""
lunch "atomx_$DEVICE-$BUILD_TYPE"
ATOMX_VERSION="$(get_build_var ATOMX_VERSION)"
checkExit
echo -e ""
