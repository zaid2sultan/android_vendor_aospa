...
"""
Merge script for The AtomX Project

 The source directory; this is automatically two folder up because the script
 is located in vendor/atomx/build/tools. Other ROMs will need to change this. The logic is
 as follows:
